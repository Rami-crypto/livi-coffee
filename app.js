...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      locSub: 'Easily locate LiVi Cafe in Desouk using Google Maps, Apple Maps, or the Plus Code below.',
      ...
      btnOpenAppleMap: 'Open in Apple Maps',
      viewGoogleMap: 'Google Maps',
      viewAppleMap: 'Apple Maps',
    ...
    ar: {
      ...
      locSub: 'يمكنك الوصول إلينا بسهولة في دسوق عبر خرائط جوجل، خرائط آبل، أو الرمز الجغرافي Plus Code أدناه.',
      ...
      btnOpenMap: 'فتح في خرائط جوجل',
      btnOpenAppleMap: 'فتح في خرائط آبل (Apple Maps)',
      viewGoogleMap: 'خرائط جوجل',
      viewAppleMap: 'خرائط آبل',
